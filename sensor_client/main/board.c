...
extern void example_ble_mesh_send_sensor_message(uint32_t opcode, int adress);
...
static void button_tap_cb(void* arg)
{
    ...
    example_ble_mesh_send_sensor_message(send_opcode[press_count], 5);
    example_ble_mesh_send_sensor_message(send_opcode[press_count++], 6);
